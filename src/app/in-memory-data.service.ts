...
｢笑顔｣のために'},
      ...
      { id: 56, name: '森井元志', role: '', belongs: '愛知県議会', almaMater: '', district: '名古屋市守山区', count: 0, twitter: 'motoshimorii', congressman: false, candidate: true, localcandidate: true, candidateType: '愛知県議会議員選挙', candidatedistrictblock: '東海', candidatePrefecture: '愛知県', candidatedistrict: '名古屋市守山区', image: 'https://new-kokumin.jp/wp-content/uploads/2021/03/…db751a4459aa76c8650657e-scaled-e1665113999493.jpg' },
    ];
    return {heroes};
  }
