...
｢笑顔｣のために'},
      ...
      { id: 57, name: '吉村大志郎', role: '', belongs: '宮崎県議会', almaMater: '', district: '宮崎氏', count: 0, twitter: 'Shiro117385631', congressman: false, candidate: true, localcandidate: true, candidateType: '宮崎県議会議員選挙', candidatedistrictblock: '九州', candidatePrefecture: '宮崎県', candidatedistrict: '宮崎氏', image: 'https://new-kokumin.jp/wp-content/uploads/2022/09/b24da5ed64f6211e448a7fb02074d10f-scaled-e1665131017481.jpg' },
    ];
    return {heroes};
  }
