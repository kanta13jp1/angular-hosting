...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const heroes = [
      { id: 1, name: '玉木雄一郎', role: '代表', belongs: '衆議院', almaMater: '東京大学法学部', district: '香川2区', count: 4, twitter: 'tamakiyuichiro', wikipedia: '玉木雄一郎', birthday: '', congressman: true, candidate: true, group: true, candidateType: '小選挙区', candidatedistrictblock: '四国', candidatePrefecture: '香川', candidatedistrict: '2区', image: 'assets/tamakiyuuichiro.jpg' },
      { id: 2, name: '山尾志桜里', role: '広報局長', role2: '憲法調査会長', belongs: '衆議院', almaMater: '東京大学法学部', district: '愛知7区', count: 3, twitter: 'ShioriYamao', congressman: true, candidate: true, group: true, candidateType: '比例代表', candidatedistrictblock: '東京', candidatePrefecture: '東京', candidatedistrict: 'ブロック単独１位', image: 'assets/yamaoshiori.jpg' },
      { id: 3, name: '伊藤孝恵', role: '副代表', belongs: '参議院', almaMater: '金城学院大学文学部国文学科', district: '愛知県選挙区',　count: 1, twitter: 'itotakae0630', congressman: true, group: true, image: 'assets/itotakae.jpg' },
      { id: 4, name: '矢田わか子', role: '副代表', belongs: '参議院', almaMater: '大阪府立寝屋川高等学校', district: '比例区', count: 1, twitter: 'wako0501', wikipedia: '矢田稚子', birthday: '1965/9/25', congressman: true, group: true, image: 'assets/yatawakako.jpg'  },
      ...
      { id: 7, name: '浅野哲', role: '国対委員長代理', belongs: '衆議院', almaMater: '青山学院大学大学院理工学研究科', district: '茨城5区', count: 1, twitter: '', congressman: true, candidate: true, group: true, candidateType: '小選挙区', candidatedistrictblock: '北関東', candidatePrefecture: '茨城', candidatedistrict: '5区', image: 'assets/asanosatoshi.jpg'  },
      ...
      { id: 13, name: '舟山康江', role: '政務調査会長', belongs: '参議院', almaMater: '北海道大学農学部農業経済学科', district: '	山形県選挙区', twitter: 'yasue_funayama0', congressman: true, image: 'assets/funayamayasue.jpg' },
      ...
      { id: 26, name: '田村まみ', role: '無所属', belongs: '参議院', almaMater: '同志社大学神学部', district: '比例区', count: 1, twitter: 'mamitamuratw', wikipedia: '田村麻美', congressman: false, candidate: false, group: true, candidateType: '', candidatedistrictblock: '', candidatePrefecture: '', candidatedistrict: '', image: 'assets/tamuramami.jpg' },
