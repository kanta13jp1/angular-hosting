...
｢笑顔｣のために'},
      ...
      { id: 58, name: '吉村大志郎', role: '', belongs: '田原市議会', almaMater: '', district: '田原市', count: 0, twitter: 'nkm27', birthday: '1993/07/25',congressman: false, candidate: true, localcandidate: true, candidateType: '田原市議会議員選挙', candidatedistrictblock: '東海', candidatePrefecture: '愛知県', candidatedistrict: '田原市', image: 'https://new-kokumin.jp/wp-content/uploads/2022/12/IMG_0290-e1672116228794.jpg' },
    ];
    return {heroes};
  }
