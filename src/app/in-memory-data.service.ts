...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const heroes = [
      { id: 1, name: '玉木雄一郎', role: '代表', belongs: '衆議院', almaMater: '東京大学法学部', district: '香川2区', twitter: 'tamakiyuichiro'},
      { id: 2, name: '山尾志桜里', role: '広報局長', role2: '憲法調査会長', belongs: '衆議院', almaMater: '東京大学法学部', district: '愛知7区', twitter: 'ShioriYamao' },
      { id: 3, name: '伊藤孝恵', role: '副代表', belongs: '参議院', almaMater: '', district: '', twitter: '' },
      { id: 4, name: '矢田わか子', role: '副代表', belongs: '参議院', almaMater: '', district: '', twitter: '' },
      { id: 5, name: '岸本周平', role: '幹事長代理', belongs: '衆議院', almaMater: '', district: '', twitter: '' },
      ...
      { id: 13, name: '舟山康江', role: '政務調査会長', belongs: '参議院', almaMater: '', district: '', twitter: '' },
      { id: 14, name: '川合孝典', role: '参議院国会対策委員長', belongs: '参議院', almaMater: '', district: '', twitter: ''},
      { id: 15, name: '大塚耕平', role: '代表代行', belongs: '参議院', almaMater: '', district: '', twitter: '' },
